...
const DefaultModal = forwardRef(function DefaultModal({children, ...props}, ref) {
    ...
    return (
        <>
             <dialog ref={ref} className=" transition bg-zinc-900 animate-openmenu sm:w-4/12 w-full h-2/4 backdrop:bg-gray-300 backdrop:opacity-20 border-4 border-zinc-700 rounded-2xl">
