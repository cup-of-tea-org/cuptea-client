    ...
    return (
        <div className='w-full h-24 flex items-center sm:px-48 px-10 '>
            ...
            <div className="flex w-full justify-end items-center ">
                <p className="text-center border-2 w-16 cursor-pointer rounded-xl hover:scale-105 transition hover:bg-white hover:text-black" onClick={handleClickButton}>{children}</p>
            </div>
            <ButtonClickModal ref={dialogRef}>{props.nickname} 님을 삭제하시겠습니까?</ButtonClickModal>
        </div>
