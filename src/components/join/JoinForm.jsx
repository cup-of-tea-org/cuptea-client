    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center">
                <form>
                    <ProfileInput type={'file'} id={'profile'}>Profile</ProfileInput>
                    ...
                    <LoginButton css={loginMainButtonCss + ' hover:border-emerald-300 mt-8 cursor-pointer'} isSocial={false}>회원가입</LoginButton>
                </form>
            </div>
        </div>
