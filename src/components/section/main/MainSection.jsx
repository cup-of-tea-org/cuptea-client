...
function MainSection({children, ...props}) {
    ...
    return (
        <>
            <div className="h-full sm:h-48 border sm:border rounded-3xl border-gray-300 sm:mx-16 mx-8 my-12 
            ...
            text-lg cursor-pointer hover:border-green-400 transition hover:scale-105" onClick={handleClickNav}>
                <img src={props.img} alt="menu" className="sm:w-32 h-32 w-24 sm:h-full sm:mx-12 py-4"/>
