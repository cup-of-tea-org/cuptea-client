        ...
        <>
            <div className='w-screen font-Jua'>
                <div className='flex mt-8 mx-4'>
                    ...
                    <h1 className='mt-5 sm:text-2xl text-xl'>질문지 만들기</h1>
                </div>
                <section className='w-full rounded-xl flex justify-center items-center animate-openmenu'>
                    <form>
                        ...
                        <div className='flex justify-center items-center w-full mt-8 sm:text-2xl '>
                        ...
                        <div className='flex justify-center items-center'>
                            <button type='button' className='w-24 sm:text-lg py-2 bg-black border-2 border-slate-100 rounded-xl text-center my-4 hover:scale-105 transition mx-8 hover:border-sky-500'>
                                만들기
                            </button>
                        </div>
                    </form>
