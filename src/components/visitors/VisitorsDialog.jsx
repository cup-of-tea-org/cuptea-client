                    ...
                    <div className="sm:w-full sm:h-full h-full flex sm:flex-row flex-col ">    
                        ...
                        <div className="w-full text-white mt-4 flex flex-col ">
                            ...
                            <div className="inline">
                                ...
                                <input id="comment" className=" w-9/12 sm:w-10/12 bg-black text-sm ml-4 sm:pr-2 pb-1 " placeholder="댓글을 입력해주세요... "/>
                                <button className="bg-black text-gray-200 2/12 sm:mr-2 ml-2 cursor-pointer hover:text-blue-400 transition hover:scale-105 text-sm">게시</button>
                            </div>
                        </div>
