...
const VisitorsDialog = forwardRef(function VisitorsDialog({children, ...props}, ref) {
    ...
    return (
        <>  
                <dialog ref={ref} className=" transition w-3/4 bg-black bg-opacity-100 animate-openmenu h-3/4 backdrop:bg-gray-200 backdrop:opacity-10 ">
                    ...
                    <div className="sm:w-full sm:h-full h-full flex sm:flex-row flex-col ">    
                        ...
                        <div className="w-full text-white mt-4 flex flex-col ">
                            ...
                            <div className="inline">
                                ...
                                <input id="comment" className=" w-9/12 sm:w-10/12 bg-black text-sm ml-2 sm:pr-2 pb-1 " placeholder="댓글을 입력해주세요... "/>
                                <button className="bg-black text-gray-200 1/12 sm:mx-4 cursor-pointer hover:text-blue-400 transition hover:scale-105 text-sm">게시</button>
                            </div>
                        </div>
